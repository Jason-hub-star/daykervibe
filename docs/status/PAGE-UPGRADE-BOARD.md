...
| `/hackathons/:slug` | Hackathon Detail | Portal | P0 | Done | `docs/ref/hackathons/daker-handover-2026-03.md`, `docs/wireframe.md` | 필수 8개 섹션과 팀 섹션 작전실 이동 흐름 구현 완료 |
| `/camp` | Team Camp | Collaboration | P0 | Done | `docs/schema.md`, `docs/wireframe.md` | 팀 모집 허브, 생성 폼, 작전실 열기 CTA 구현 완료 |
| `/rankings` | Rankings | Portal | P1 | Done | `docs/schema.md` | 글로벌 랭킹 기본형 구현 완료 |
| `/war-room/:teamId` | War Room | Collaboration | P0 | Done | `docs/Prd.md`, `docs/architecture-diagrams.md` | 베이스캠프 + 제출 준비 관리 허브 구현 완료, `/camp`와 상세 팀 섹션에서 진입 가능 |
